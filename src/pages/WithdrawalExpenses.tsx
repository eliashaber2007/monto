                ...
                {exp.receipt_url && (
                  <div className="ml-12">
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-semibold text-primary bg-transparent border border-primary/40 px-3 py-1 rounded-full hover:bg-primary/10 transition-colors"
                    >
                      <Receipt size={12} />
                      View receipt
                    </a>
