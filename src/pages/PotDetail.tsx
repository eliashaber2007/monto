        ...
        <div className="max-w-lg mx-auto px-5 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="relative flex flex-col items-center gap-0.5 px-3 py-2 bg-secondary/15 border border-secondary/30 text-primary rounded-full flex-shrink-0"
            >
            ...
            <button
              ...
              className="flex flex-col items-center gap-0.5 px-3 py-2 bg-secondary/15 border border-secondary/30 text-primary rounded-full flex-shrink-0"
            >
              <Users size={20} />
