        ...
        <div className="max-w-lg mx-auto px-5 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="relative flex flex-col items-center gap-0.5 px-3 py-2 bg-secondary text-secondary-foreground rounded-full flex-shrink-0"
            >
            ...
            <button
              ...
              className="flex flex-col items-center gap-0.5 px-3 py-2 bg-secondary text-secondary-foreground rounded-full flex-shrink-0"
            >
              <Users size={20} />
